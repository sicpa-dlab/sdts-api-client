...
- API version: 0.0.1
  - Build date: 2020-12-23T15:13:07.571806+01:00[Europe/Zurich]
...
```groovy
compile "com.sicpa.edison:edison-credentials-client:0.0.33"
```
...
* `target/edison-credentials-client-0.0.33.jar`
* `target/lib/*.jar`
...
*CredentialsApi* | [**issuanceCredentialCredentialIdDelete**](docs/CredentialsApi.md#issuanceCredentialCredentialIdDelete) | **DELETE** /credentials-issuance/{credentialExchangeId} | Delete the specified issued credential
*CredentialsApi* | [**issuanceCredentialCredentialIdGet**](docs/CredentialsApi.md#issuanceCredentialCredentialIdGet) | **GET** /credentials-issuance/{credentialExchangeId} | Get the specified issued credential
*CredentialsApi* | [**issuanceCredentialPost**](docs/CredentialsApi.md#issuanceCredentialPost) | **POST** /credentials-issuance | Issue new credentials
*CredentialsApi* | [**issuanceCredentialsGet**](docs/CredentialsApi.md#issuanceCredentialsGet) | **GET** /credentials-issuance | List all issued credentials
*InternalWebhooksApi* | [**webhooksGet**](docs/InternalWebhooksApi.md#webhooksGet) | **GET** /internal/webhooks | List an organization&#39;s active webhooks with given type 
...
*WebhooksApi* | [**webhooksGet1**](docs/WebhooksApi.md#webhooksGet1) | **GET** /webhooks | List all webhooks
